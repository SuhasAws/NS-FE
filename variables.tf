...
variable "vnet3-name" {
    type = string
    description = "Virtual Network 3 Name"
}

variable "vnet3-address-space" {
    type = list(string)
    description = "Address space of virtual network3 "
}
variable "vnet3-subnet3-name" {
    type = string
    description = "Name of vnet subnet 3"
}

variable "vnet3-subnet3-address_prefixes" {
    type = list(string)
    description = "Address prefix of vnet subnet 3"
}
